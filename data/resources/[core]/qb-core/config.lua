...
QBConfig.Money.MinusLimit = -1000 -- The maximum amount you can be negative
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 8 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 8 -- Rate at which thirst goes down.
...
QBConfig.Server.Discord = 'http://discord.gg/PYqprZD5eC' -- Discord invite link
...
QBConfig.Commands.OOCColor = {
    255,
    151,
    133
} -- RGB color code for the OOC command
