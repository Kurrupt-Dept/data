...
QBShared.Items = {
    ...
    -- Addon Foods
    cayo_caramel_bar = {
        name = 'cayo_caramel_bar',
        label = 'Caramel Candy Bar',
        weight = 50,
        type = 'item',
        image = 'cayo_caramel_bar.png',
        unique = false,
        useable = true,
        shouldClose = true,
        description = ''
    ...
    frozen_apple_green = {
        name = 'frozen_apple_green',
        label = 'Frozen Apple Green',
        weight = 50,
        type = 'item',
        image = 'frozen_apple_green.png',
        unique = false,
        useable = true,
        shouldClose = true,
        description = ''
    ...
    smalljuice_apple = {
        name = 'smalljuice_apple',
        label = 'Small Box Apple Juice',
        weight = 50,
        type = 'item',
        image = 'SmallJuice_apple.png',
        unique = false,
        useable = true,
        shouldClose = true,
        description = ''
    ...
    smalljuice_grappe = {
        name = 'smalljuice_grappe',
        label = 'Small Box Grappe Juice',
        weight = 50,
        type = 'item',
        image = 'smalljuice_grappe.png',
        unique = false,
        useable = true,
        shouldClose = true,
        description = ''
    },
    smalljuice_strawberry = {
        name = 'smalljuice_strawberry',
        label = 'Small Box Strawberry Juice',
        weight = 50,
        type = 'item',
        image = 'smalljuice_strawberry.png',
        unique = false,
        useable = true,
        shouldClose = true,
        description = ''
