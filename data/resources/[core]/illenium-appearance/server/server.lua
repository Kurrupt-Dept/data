...
if Config.EnablePedMenu then
    ...
    function(source, args)
        ...
        if args.playerID then
            ...
            if citizenID then
                TriggerClientEvent('chatMessage', -1, "[^1SYSTEM^0] A force Skin Menu was given to "  .. GetPlayerName(source))
                ...
                -- TriggerClientEvent('chatMessage', -1, "There "  .. GetPlayerName(source))
                return
            end
        end
