...
Config.BlowUpChance = 50 -- Percentage for Chance of Engine Explosion (Default: 5% or 5)
Config.CostMultiplier = 1.5 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
Config.GlobalTax = 25.0 -- The tax, in %, that people will be charged at the pump. (Default: 15% or 15.0)
...
Config.JerryCanCap = 10 -- Maximum amount (in L) the jerrycan can fit! (Default: 50L)
Config.JerryCanPrice = 50 -- The price of a jerry can, not including tax.
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    [2] = {
        zones = {
            vector2(239.3868560791, -1815.6184082031),
            vector2(243.7698059082, -1819.5272216797),
            vector2(266.04144287109, -1837.5080566406),
            vector2(275.59405517578, -1826.1031494141),
            vector2(277.04077148438, -1827.3334960938),
            vector2(292.93203735352, -1808.8034667969),
            vector2(284.91717529297, -1802.0766601562),
            vector2(293.86325073242, -1791.79296875),
            vector2(277.35205078125, -1777.5052490234),
            vector2(269.08792114258, -1771.0200195312),
            vector2(246.67092895508, -1796.1737060547),
            vector2(237.703125, -1806.7290039062),
            vector2(237.38247680664, -1811.5678710938)
        },
        minz = 28.974248886108,
        maxz = 29.880184173584,
        pedmodel = "a_m_m_indian_01",
        cost = 100000,
        shutoff = false,
        pedcoords = {
        ...
        electriccharger = nil,
        electricchargercoords = vector4(284.0529, -1821.2566, 28.1304, 51.6950),
